...
static tmpl_ComplexDouble f(tmpl_ComplexDouble z)
{
    ...
    poly = tmpl_CDouble_Poly_Eval_Real_Coeffs(coeffs, 3, z);
    return tmpl_CDouble_Multiply(tmpl_CDouble_Exp(z), poly);
}
...
{
    tmpl_ComplexDouble poly;
    const double coeffs[4] = {-1.0, 0.0, 3.0, 1.0};
...
{
    tmpl_ComplexDouble poly;
    const double coeffs[4] = {-1.0, 6.0, 6.0, 1.0};
