...
int main(void)
{
    ...
    tmpl_fp = fopen("tmpl_bessel_j0_binary", "w");
    ...
    system("graph -T ps -I d < tmpl_bessel_j0_binary gsl_bessel_j0_binary "
           "-L \"Bessel J0\" --reposition 0.0 -0.8 1 diff_binary "
           "-L \"Difference (tmpl vs gsl)\" > bessel_J0.ps");
    system("rm -f tmpl_bessel_j0_binary gsl_bessel_j0_binary diff_binary");
    return 0;
}
