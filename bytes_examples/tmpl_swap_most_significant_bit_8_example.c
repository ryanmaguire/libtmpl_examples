...
int main(void)
{
    ...
    else if (sizeof(unsigned long long int) == 8)
    {
        union {
    ...
    /*  If we get here, there is no integer data type that is 8 char's wide.  *
     *  Print this and exit the function.                                     */
    else
        puts("Could not find integer type with sizeof = 8");
