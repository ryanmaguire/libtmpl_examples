 ...
 ******************************************************************************
 *  Purpose:                                                                  *
 *      Provides an example of using tmpl_Float_Arctan function.              *
 ******************************************************************************
 *  Author:     Ryan Maguire                                                  *
...
/*  tmpl_Float_Arctan function found here.                                    */
#include <libtmpl/include/tmpl_math.h>

/*  Function for showing use of tmpl_Float_Arctan function.                   */
int main(void)
{
    ...
    /*  Run tmpl_Float_Arctan on the test values.                             */
    for (n = 0U; n < sizeof(x)/sizeof(x[0]); ++n)
    {
        out = tmpl_Float_Arctan(x[n]);
