...
int main(void)
{
    ...
    tmpl_ComplexDouble z0[9], z1[9];
    double re_z0, im_z0, re_z1, im_z1;
    ...
    z0[3] = tmpl_CDouble_I;
    z0[4] = tmpl_CDouble_Rect(-1.0, 1.0);
    z0[5] = tmpl_CDouble_Rect(-1.0, 0.0);
    z0[6] = tmpl_CDouble_Rect(-1.0, -1.0);
    z0[7] = tmpl_CDouble_Rect(0.0, -1.0);
    z0[8] = tmpl_CDouble_Rect(1.0, -1.0);

    /*  Set the test values in the array z1.                                  */
    z1[0] = tmpl_CDouble_Zero;
    z1[1] = tmpl_CDouble_Rect(1.0, 1.0);
    z1[2] = tmpl_CDouble_One;
    z1[3] = tmpl_CDouble_I;
    z1[4] = tmpl_CDouble_Rect(-1.0, 0.0);
    z1[5] = tmpl_CDouble_Rect(-1.0, 1.0);
    z1[6] = tmpl_CDouble_Rect(-1.0, -1.0);
    z1[7] = tmpl_CDouble_Rect(1.0, -1.0);
    z1[8] = tmpl_CDouble_Rect(0.0, -1.0);
    ...
    for (n = 0U; n < 9U; ++n)
    {
        ...
        if (tmpl_CDouble_Compare(z0[n], z1[n]))
