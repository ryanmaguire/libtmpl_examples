...
/*  This program plots the real and imaginary parts of the complimentary      *
 *  error function using a color gradient to represent the values.            */
...
/*  Function for plotting complimentary error function.                       */
int main(void)
{
    ...
    /*  Plot the function.                                                    */
    tmpl_PPM_Complex_Plot("complex_erfc", tmpl_CDouble_Erfc,
