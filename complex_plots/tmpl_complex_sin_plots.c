...
/*  This program plots the real and imaginary parts of the complex sine       *
...
/*  Function for plotting complex sine.                                       */
int main(void)
{
    ...
    /*  Plot the function.                                                    */
    tmpl_PPM_Complex_Plot("complex_sin", tmpl_CDouble_Sin,
