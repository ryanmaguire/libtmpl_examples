...
/*  This program plots the real and imaginary parts of the complex Faddeeva   *
...
/*  Function for plotting complex Faddeeva.                                   */
int main(void)
{
    ...
    /*  Plot the function.                                                    */
    tmpl_PPM_Complex_Plot("complex_faddeeva", tmpl_CDouble_Faddeeva,
