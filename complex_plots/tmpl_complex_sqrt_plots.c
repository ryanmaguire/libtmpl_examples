...
/*  This program plots the real and imaginary parts of the complex square     *
 *  root function using a color gradient to represent the values.             */
...
/*  Function for plotting complex square root.                                */
int main(void)
{
    ...
    /*  Plot the function.                                                    */
    tmpl_PPM_Complex_Plot("complex_sqrt", tmpl_CDouble_Sqrt,
