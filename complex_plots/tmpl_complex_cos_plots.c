...
/*  This program plots the real and imaginary parts of the complex cosine     *
...
/*  Function for plotting complex cosine.                                     */
int main(void)
{
    ...
    /*  Plot the function.                                                    */
    tmpl_PPM_Complex_Plot("complex_cos", tmpl_CDouble_Cos,
